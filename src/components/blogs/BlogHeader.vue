<script>
export default {
	props: ['singleBlogHeader'],
};
</script>

<template>
	<div class="flex flex-col items-center">
		<!-- Blog heading and meta info -->
		<p
		...
		>
			{{ singleBlogHeader.singleBlogTitle }}
		</p>
		<div class="flex">
			<div class="flex items-center mr-10">
				...
				<span
					...
					>{{ singleBlogHeader.singleBlogDate }}</span
				>
			</div>
			<div class="flex items-center">
				...
				<span
					class="font-general-medium ml-2 leading-none text-primary-dark dark:text-primary-light"
					>{{ singleBlogHeader.singleBlogTag }}</span
				>
			</div>
		</div>
	</div>
